...
#chapter(
  "Chapter Two",
  "content for the second chapter, but this time in part two",
)
#lorem(100)

#chapter(
  "Chapter Three",
  "Why not add a third chapter while we're at it, but this time in part two",
)
#lorem(100)
...
#chapter(
  "Chapter One",
  "content for first chapter, but in in part three. Whaaaaat????",
)
#lorem(100)

#chapter(
  "Chapter Two",
  "content for the second chapter, and still in part three",
)
#lorem(100)
...
#chapter(
  "Chapter Two",
  "content for the second chapter in part four. Brace yourselves!",
)
#lorem(100)

#chapter(
  "Chapter Three",
  "Why not add a third chapter while we're at it, but this time in part four. Get ready!",
)
#lorem(100)
...
#chapter(
  "Chapter One",
  "content for first chapter, but this time in part five. Can you handle it?",
)
#lorem(100)

#chapter(
  "Chapter Two",
  "content for the second chapter, but this time in part five. Prepare for thrills!",
)
#lorem(100)

#chapter(
  "Chapter Three",
  "Why not add a third chapter while we're at it, but this time in part five. It's about to get wild!",
)
#lorem(100)
...
#chapter(
  "Chapter One",
  "content for first chapter, but this time in part six. The climax begins!",
)
#lorem(100)

#chapter(
  "Chapter Two",
  "content for the second chapter, but this time in part six. Get ready for the big reveal!",
)
#lorem(100)

#chapter(
  "Chapter Three",
  "Why not add a third chapter while we're at it, but this time in part six. Hold onto your seats!",
)
#lorem(100)
